...
function showquery(str){
	var url = "<%=baseWebPath%>/servlet/icbc.cmis.servlets.CmisReqServlet?operationName=icbc.cmis.flow.util.util_content_msg_geneOp&opDataUnclear=true&opAction=10002"
			+"&msg_g_entcode=<%=flow_entcode%>"
			+"&msg_g_tradecode=<%=flow_tradecode%>"
			+"&msg_g_ordernum=" + str
			+"&time="+(new Date);
...
<td align="center" class="td1"><cmis:muiitem item="C000038" exp="意见说明"/></td>
