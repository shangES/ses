...
<td align="center" class="td1"><cmis:muiitem item="C000020" exp="检查期"/></td>
<!--<td align="center" class="td1">调整种类</td>-->
<td align="center" class="td1"><cmis:muiitem item="C000021" exp="检查次数"/></td>
