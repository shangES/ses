...
<head>
<title>
<cmis:muipub item="P000169" exp="待本人处理"/>
</title>
...
<cmis:framework align="center">
	...
	<cmis:tabpagebar titleid="C000006" onclick="nobanklist();" selected="false"/><!--待本行处理-->
	<cmis:tabpagebar titleid="C000007" selected="true"/><!--待本人处理-->
...
<tr <%if(i%2==0){%>bgcolor="ffffff"<%}else{%>bgcolor="f1f1f1"<%}%>>
    <td align="center" ><INPUT TYPE="checkbox" NAME="cs"  value='<%=","+process001+","+process002+","+process003+","+process004+","+process005+","+process006+","+process007+","+process008%>'></td>
	<td>&nbsp;<%=process001%></td>
	<td>&nbsp;<%=ta200011003%></td>
	<td>&nbsp;<%=process002%></td>
    <td>&nbsp;<%=kind_name%></td>
