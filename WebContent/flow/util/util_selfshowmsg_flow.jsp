...
function save()
{
  window.returnValue = form1.process012.value;
  window.close();  
}
...
<form name="form1" method="post" action="<%=baseWebPath%>/servlet/icbc.cmis.servlets.CmisReqServlet">
	<input type=hidden name="operationName" value="icbc.cmis.flow.util.util_content_msg">
	<input type=hidden name="opAction" value="">
<div align="center"> <cmis:tabpage width="0" height="0"> 
<cmis:tabpagebar  titleid="C000091" selected="true" />
  ...
  <tr>
	    <td  class="td1"><cmis:muiitem item="C000091"/><cmis:muiitem item="C000090"/></td> <!-- 意见说明(最多输入500个汉字) -->
	    </tr>

    <tr>
      <td class="td1">
       
         <TEXTAREA NAME="process012" ROWS="5" COLS="80"  onblur="javascript:checkAreaLength(this,1000);javascript:checkSyntax(this);"><%=documentcontent%></TEXTAREA>   
