function gene_tuihui(){
	...
	var parameter= "operationName=icbc.cmis.flow.BTN.gene_tuihuiOp&opDataUnclear=true&opAction=10000";
	...
	//做退回
	form2.operationName.value = "icbc.cmis.flow.BTN.gene_tuihuiOp";
