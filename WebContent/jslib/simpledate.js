...
if(v_date==""){
	...
	document.write("<input size=14 maxlength=8 type=text name=\""+name+"temp\" value='"+y1+"年"+m1+"月"+d1+"日"+"' onFocus=\"decodeDate('"+name+"')\" onBlur=\"encodeDate('"+name+"')\" class=tablebody>");
}
