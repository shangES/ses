...
public class QueryNormalEnp {

	public QueryNormalEnp() {
	}
	...
	public String getWhere(Connection conn,Employee employee,Hashtable paras) {
			...
			String emajor = employee.getEmployeeMajor();
		...
		//输入已完成
		where += (" and TA200011059 in ('1','5') and TA200011083 = 1");
