...
public class ChooseEnp6 extends HttpServlet {
...
//  private static final String CONTENT_TYPE = "text/xml";
  ...
  public void newQuery(HttpServletRequest request,CMisSessionMgr session,PrintWriter out) throws TranFailException {
    ...
    try {
      ...
      ChooseEnp6DAO dao = new ChooseEnp6DAO(new icbc.cmis.operation.DummyOperation());
...
//      session.updateSessionData("sql3GB2U",sql);
      int rowCount = dao.getCount(queryType,employee,TA200011001,TA200011003,TA200011005,TA200011010,TA200011011,TA200011012,TA200011014,TA200011016,TA200011031,paras);
...
//        newString += "ROWNUM <= "+ bufferEnd +" ) WHERE rnum >= "+ bufferBegin ;
        ...
        ChooseEnp6DAO dao = new ChooseEnp6DAO(new icbc.cmis.operation.DummyOperation());
        datas = dao.getData(queryType,employee,TA200011001,TA200011003,TA200011005,TA200011010,TA200011011,TA200011012,TA200011014,TA200011016,TA200011031,paras,bufferBegin,bufferEnd);
        ...
        try {
          ...
          throw new TranFailException("cmisUTIL803","icbc.cmis.util.ChooseEnp6",ex.getMessage(),"取缓存数据出错！");
        }
      }
      ...
      throw new TranFailException("cmisUTIL801","icbc.cmis.util.ChooseEnp6",ex.getMessage(),"取数据出错！");
    }
