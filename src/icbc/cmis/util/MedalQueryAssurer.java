...
public class MedalQueryAssurer extends QueryNormalEnp {
  ...
  public String getWhere(Connection conn,Employee employee, Hashtable paras) {
     ...
     /*
       ...
       比照信用等级)，且在企业大事记表中无大事的、在黑名单表中无记录的、在企业逃废债表中无记录的
     */
