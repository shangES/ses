 ...
 * @version: 1.0<br>
 */
public class util_ChooseBank extends HttpServlet {
...
public void clear(
    ...
    try {
        ...
        if (ciscode.equals("")) {
            ...
            session.addSessionData("CisCodeInSession", ciscode);
    ...
    try {
        ...
        if (flag.equals("newQuery")) {
            ...
            if (flag.equals("query")) {
                ...
                if (flag.equals("done")) {
                    String ciscode = Decode.decode(request.getParameter("ciscode"));
                    String shortname = Decode.decode(request.getParameter("shortname"));
                    clear(session, out, ciscode, shortname);
                }
...
public void newQuery(
    ...
    try {
        ...
        String ciscode = request.getParameter("ciscode");
        if (ciscode == null)
            ciscode = "";
        ...
        util_ChooseBankDAO dao =
            new util_ChooseBankDAO(new icbc.cmis.operation.DummyOperation());
        String sql[] = dao.genSQL(queryType, employee, ciscode, shortname, paras);
    ...
    try {
        ...
        if (datas != null && !datas.isEmpty()) {
            for (int i = 0; i <= end - begin; i++) {
                ...
                /** bankvest, ciscode, shortname, fullname, institution,  rownum, bankvestname, provincename ,hangye */
                out.print(
                    "<en o='"
                        + row[5]
                        + "' c='"
