...
//updated by chenj 20030526
        ...
        try {
          ...
          throw new TranFailException("cmisUTIL803","icbc.cmis.util.ChooseEnpBift",ex.getMessage(),"取缓存数据出错！");
        }
      }
      ...
      throw new TranFailException("cmisUTIL801","icbc.cmis.util.ChooseEnpBift",ex.getMessage(),"取数据出错！");
    }
  ...
  public void clear(CMisSessionMgr session,PrintWriter out,String ccode,String cname) {
    ...
    try {
      ...
      //add by chenj for 点返回不清掉session数据
      if(ccode.equals("")){
