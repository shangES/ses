...
public class BA_approvedoDao extends CmisDao {

	String sLangCode = "zh_CN";

	public BA_approvedoDao(icbc.cmis.operation.CmisOperation op) {
		super(op);		
	}
	 ...
	 */
	public ArrayList queryfragment(String ordercode, String spflag,
			String tradetype) throws TranFailException {
		...
		try {
			...
			sql = "select fragment_url,fragment_init from mag_approve_content_show ,mag_approve_content_fragment "
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.queryfragment()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
	 ...
	 * @throws TranFailException
	 */
	public ArrayList querybutton(String ordercode, String spflag,
			String tradetype) throws TranFailException {
		ArrayList vret = new ArrayList();
		java.sql.ResultSet rs = null;
		java.sql.PreparedStatement pstmt = null;
		...
		try {
			this.getConnection("cmis3");
			sql = "select button_gif,button_url from mag_approve_content_show ,mag_approve_content_button "
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.querybutton()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
	 ...
	 * @throws TranFailException
	 */
	public String getordername(String flowtype, String ordercode)
			throws TranFailException {
		String str = "";
		java.sql.ResultSet rs = null;
		java.sql.PreparedStatement pstmt = null;
		...
		try {
			this.getConnection("cmis3");
			sql = "select role_name from imag_role_major_new where role_code = ? and role_type = (select kind_type from imag_kind where kind_code = ? and lang_code='"+sLangCode+"') and lang_code='"+sLangCode+"'";
			pstmt = conn.prepareStatement(sql);
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.getordername()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
	 ...
	 * @throws TranFailException
	 */
	public String getinfourl(String tradetype, String entcode, String entname,
			String tradecode) throws TranFailException {
		String infourl = "";
		java.sql.ResultSet rs = null;
		java.sql.PreparedStatement pstmt = null;
		...
		try {
			this.getConnection("cmis3");
			sql = "select tabname,URLPrefix,entCode,entName,tradeCode,info01 "
					+ "from mag_approve_tab_info "
					+ "where applycode=? and infotype='0' and LANG_CODE=?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, tradetype);
			...
			if (rs.next()) {
				...
				infourl = URLPrefix + "&" + s_entCode + "=" + entcode + "&"
						+ s_entName + "=" + java.net.URLEncoder.encode(entname)
						+ "&" + s_tradeCode + "="
						+ java.net.URLEncoder.encode(tradecode) + info01;

			}

			sql = "select tabname,infopro from mag_approve_tab_info where applycode=? and infotype='1' and LANG_CODE=?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, tradetype);
			pstmt.setString(2, sLangCode);
			rs = pstmt.executeQuery();
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.getinfourl()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
	...
	public String getinfoname(String tradetype) throws TranFailException {
		...
		try {
			this.getConnection("cmis3");
			sql = "select tabname from mag_approve_tab_info where applycode=? and LANG_CODE=?";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, tradetype);
			pstmt.setString(2, sLangCode);
			rs = pstmt.executeQuery();
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.getinfoname()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
	 ...
	 * @throws TranFailException
	 */
	public String checkfirst(String entcode, String tradecode,
		...
		try {
			...
			if (rs.next()) {
				...
				if (process006.equals(ordercode)
						&& process007.equals(empareacode)
						&& process008.equals(employeecode)) {
					str = "1";
				}
			} else {
				str = "1";
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.checkfirst()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
	 ...
	 * @throws TranFailException
	 */
	public ArrayList getcrediturl(String approve_tradetype, String reurnurl,
			String webBasePath, String entcode_value, String entname_value)
			throws TranFailException {
		ArrayList vret = new ArrayList();
		java.sql.ResultSet rs = null;
		java.sql.PreparedStatement pstmt = null;
		...
		try {
			this.getConnection("cmis3");
			sql = "select urlname,URLPrefix,entcode,entname,returnurl,credit001 from mag_approve_credit where creditcode in (select creditcode from mag_approve_credit_tab where flowcode = ? ) and LANG_CODE=? ";
			pstmt = conn.prepareStatement(sql);
			...
			while (rs.next()) {
				...
				String url = webBasePath + s_URLPrefix + "&" + s_entcode + "="
						+ entcode_value + "&" + s_entname + "="
						+ java.net.URLEncoder.encode(entname_value) + "&"
						+ s_returnurl + "="
						+ java.net.URLEncoder.encode(reurnurl) + s_credit001;
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.querylist_me()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
	 ...
	 * @throws TranFailException
	 */
	public ArrayList makeextratab(String entcode, String entname,
			String tradecode, String tradetype, String webBasePath)
			throws TranFailException {
		ArrayList vret = new ArrayList();
		java.sql.ResultSet rs = null;
		java.sql.PreparedStatement pstmt = null;
		...
		try {
			this.getConnection("cmis3");
			//生成定义的链接
			sql = "select taborder,tabname,urlprefix,entcode,entname,tradecode,extra001 "
					+ "from mag_approve_tab_extra "
					+ "where tradetype=? and proshow='0' and LANG_CODE=? order by taborder";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, tradetype);
			pstmt.setString(2, sLangCode);
			rs = pstmt.executeQuery();
			while (rs.next()) {
				...
				String taburl = webBasePath + s_urlprefix + "&" + s_entcode
						+ "=" + entcode + "&" + s_entname + "="
						+ java.net.URLEncoder.encode(entname) + "&"
						+ s_tradecode + "="
						+ java.net.URLEncoder.encode(tradecode) + s_extra001;
				hmap.put("taburl", taburl);
				vret.add(hmap);
			}

			//生成需要存储过程来生成的链接
			sql = "select taborder,tabname,prourl from mag_approve_tab_extra where tradetype=? and proshow='1' and LANG_CODE=? order by taborder";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, tradetype);
			pstmt.setString(2, sLangCode);
			rs = pstmt.executeQuery();
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.makeextratab()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
	...
	public String isshowtab2(String tradetype) throws TranFailException {
		...
		try {
			this.getConnection("cmis3");
			sql = "select SHOWTAB2 from mag_approve_tab_info where applycode = ? and lang_code='"+sLangCode+"'";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, tradetype);
			rs = pstmt.executeQuery();
			while (rs.next()) {
			...
			throw new TranFailException("icbc.cmis.flow.BA",
					"BA_approvedoDao.showtab2()", e.getMessage(), e
							.getMessage());
		} finally {
			if (rs != null)
				try {
