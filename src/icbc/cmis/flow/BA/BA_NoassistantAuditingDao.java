 ...
 */
public class BA_NoassistantAuditingDao extends CmisDao {
	String langCode = "zh_CN";
	public BA_NoassistantAuditingDao(icbc.cmis.operation.CmisOperation op) {
		super(op);
		try {
		...
		try {
			...
			sql =
				"select rownum rnum, advice001,(select ta200011003 from ta200011 where ta200011001 = advice001) advice001_name,"
					...
					+ "process004,(select pa002 from ipa200021 where pa001 = process004 and lang_code='"+langCode+"') process004_name,"
					+ "advice006 "
