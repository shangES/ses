 ...
 * @version 1.0
 */
public class unit_content_nopersonbanklistDao1 extends CmisDao {

	String langCode="zh_CN";
	public unit_content_nopersonbanklistDao1(CmisOperation op) {
		super(op);
		try
		{
	...
	public ArrayList getflowlist(String flowtype, String busi_type)
		...
		try {
			...
			sql = " select role_code,role_name"
					...
					+ " where role_type= (select kind_type from mag_kind where kind_code=?) and lang_code='"+langCode+"' and role_flag='1' order by role_code ";
			pstmt = conn.prepareStatement(sql);
	...
	public Vector getnopersonlist(String areacode, String employeecode,
		...
		queryStr = "select process001,(select ta200011003 from ta200011 where ta200011001 = process001) as ta200011003,process002,"
				...
				+ "process004,(select pa002 from pa200021 where pa001 = process004 and lang_code='"+langCode+"') as pa002, "
				...
				+ " from mprocess_new "
				+ " where process006='7' and process007 = ? and process004 in (select pa001 from pa200021 where pa004=?  and lang_code='"+langCode+"' ) and process008 = ? and ( process009 = '0' or process009 = '1' )";
	...
	public Vector getnobanklist(String areacode, String busitype)
		...
		queryStr = "select process001,(select ta200011003 from ta200011 where ta200011001 = process001) as ta200011003,process002,"
				...
				+ " from mprocess_new "
				//
				+ " where   process007 = ? and process004 in (select pa001 from pa200021 where pa004=?  and lang_code='"+langCode+"') and (process008 is null or process008='') and ( process009 = '0' or process009 = '1' )";
		try {
			DBTools srv = new DBTools(this.getOperation());
