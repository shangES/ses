 ...
 * @version 1.0
 */
public class util_content_msgDao extends CmisDao{

  public util_content_msgDao(CmisOperation op) {
    super(op);
...
/**
	 ...
	 * @throws
	 */	
	 public Vector getadvicetxt(String entcode, String tradecode, String xh, String step)
		 ...
		 try{
			 ...
			 throw new TranFailException("util_content_msgDao","util_content_msgDao.getadvicetxt",e.getMessage());
		 }
	 }
}
