 ...
 */
public class DA200251031Bean extends SelfDefineDictBean {
/**
 * DA200251031Bean constructor comment.
 */
public DA200251031Bean() {
	super();
}
/**
...
public String getOptionTagsEmty(String flag,String tfKey) {
	...
	public String getOptionTagsWithKeyName(String flag,String tfKey){
	return super.getOptionTagsWithKeyName(flag,tfKey);
}
