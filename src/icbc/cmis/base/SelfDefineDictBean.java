 ...
 */
public class SelfDefineDictBean {
	private Hashtable hTable = new Hashtable();
/**
 * SelfDefineDictBean constructor comment.
 */
public SelfDefineDictBean() {
	super();
}
/**
 ...
 */
public void addRow(String areaCode, String key, String value) {
 ...
 * @param key java.lang.String
 */
public DictBean getValues(String areaCode) {
	if(areaCode == null || areaCode.trim().length() == 0) return null;
	return (DictBean)hTable.get(areaCode.trim());
