...
public class InputNumberOpDataTag extends TagSupport {
  ...
  public int doStartTag() throws javax.servlet.jsp.JspException {
    ...
    try {
      ...
      out.print("<input type='text' id='H7D4F6Z' name='"+ name +"' size='"+ size +"' maxLength='"+ maxLength +"'  value='"+ formatStr(value) +"' dataLen='"+ dataLength +"' decLen='"+ decimalLength +"' onKeypress='inputNumber(this);' onblur='toExact(this);' onfocus='toNumber(this);'>");
    } catch (Exception ex) {
