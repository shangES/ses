 ...
 * HTML 'select' tag.
 */
public class SelectITag extends BodyTagSupport {
  ...
  public int doStartTag() throws JspTagException {
    ...
    try {
      ...
      if (source.toLowerCase().equals("tablebean") || source.toLowerCase().equals("userbean")) {
        ...
        h_table = CmisConstance.getDictParam(langCode);
      ...
      throw new JspTagException("select tag start failure:"+(e.getMessage()));
    }
